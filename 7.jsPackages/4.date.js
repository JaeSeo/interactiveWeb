...
var date = new Date();
// 원하는 날짜로 설정
// 파라미터를 써주면 원하는 날짜로 설정할 수도 있습니다. 만약 날짜만 쓸 경우, 0시 0분 0초로 지정됩니다.
...
// 주의할 점!
// getMonth()의 경우, 0부터 시작하기 때문에, 2는 3월을 의미합니다. 또 getDay()는 날짜가 아니라 요일을 리턴해주고, 일요일인 0부터 시작해서, 3은 수요일을 뜻합니다.

// 그리고...
// 이번에도 마찬가지로, 더 많은 내용을 알고싶다면 이 링크를 참고해보세요!
